...
* // returns 21
*/
declare function mapReduceRight<T = unknown, U = unknown, V = unknown, W = unknown>( arr: typedndarray<T>, initial: V, mapper: Mapper<T, U>, reducer: Reducer<U, V, T, W>, thisArg?: ThisParameterType<Reducer<U, V, T, W>> ): V;
...
* // returns 30
*/
declare function mapReduceRight<T = unknown, U = unknown, V = unknown, W = unknown>( arr: Collection<T>, initial: V, mapper: ArrayMapper<T, U>, reducer: ArrayReducer<U, V, T, W>, thisArg?: ThisParameterType<ArrayReducer<U, V, T, W>> ): V;
