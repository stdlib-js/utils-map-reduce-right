...
```javascript
import mapReduceRight from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-map-reduce-right@v0.2.2-deno/mod.js';
```
...
[@stdlib/utils/map-reduce]: https://github.com/stdlib-js/utils-map-reduce/tree/deno
